...
from ..application.usecases.role_usecases import (
    CreateRoleUseCase,
    UpdateRoleUseCase,
    DeleteRoleUseCase,
    GetRoleUseCase,
...
from .dependencies import get_role_repository, RequireRole, RequirePermission
from ...auth.domain.entities.auth_user import AuthUser
from ...auth.interface.dependencies import get_current_active_user, get_current_superuser
from ...shared.exceptions import RoleNotFoundError, RoleAlreadyExistsError, PermissionDeniedError
