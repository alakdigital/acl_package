...
from ..application.interface.permission_repository import IPermissionRepository
from ..application.usecases.permission_usecases import (
...
from ..domain.dtos.permission_dto import (
    CreatePermissionDTO,
    UpdatePermissionDTO,
...
from .dependencies import get_permission_repository
from ...auth.interface.dependencies import get_current_superuser
